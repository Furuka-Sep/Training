...
public class Quest2{
	public static void main(String[] args){
		System.out.print("何人>");
		int num=new Scanner(System.in).nextInt();//人数
		final int Balls_Num=99;//球の数
		int[] balls=new int[Balls_Num];//球の配列
		int[] hit=new int [num];//引いた球の結果
		String[] p=new String[num];//それぞれの人の配列
